 ...
 */
final class Version20211216145116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sport AS SELECT id, name FROM sport');
        ...
        $this->addSql('INSERT INTO sport (id, name) SELECT id, name FROM __temp__sport');
